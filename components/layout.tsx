...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-black">
      {/* Sidebar for desktop */}
      <div className="hidden w-64 border-r border-gray-800 bg-gray-950/50 md:block">
                ...
                {group.links.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      href={link.href}
                      className={cn(
                        "flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors hover:bg-gray-900",
                        pathname === link.href ? "bg-gray-900 text-white" : "text-gray-400"
                      )}
                    >
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="w-64 bg-gray-950/50 p-0">
          <div className="flex h-16 items-center gap-2 border-b border-gray-800 px-4">
            <PiggyBank className="h-6 w-6" />
            <span className="font-semibold">Finance Dashboard</span>
          </div>
      ...
      <div className="flex-1">
        <header className="flex h-16 items-center border-b border-gray-800">
            ...
            <div className="flex flex-1 items-center gap-4">
              <div className="flex-1 md:ml-auto md:w-80">
                <div className="relative">
                  ...
                  <Input
                    placeholder="Search..."
                    className="w-full bg-gray-950/50 pl-8"
                  />
                </div>
              </div>
